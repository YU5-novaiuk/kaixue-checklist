...
export default function Home(){
 ...
 {rationalPrep.show&&<section className="section delay-buy"><div className="section-title"><div><p className="eyebrow">{rationalPrep.eyebrow}</p><h2>{rationalPrep.title}</h2></div><Link href="/later">查看 <ArrowRight/></Link></div><p>{rationalPrep.summary}</p></section>}
